const PurchaseReturns = require("../../../models/purchase/debitNoteModel");
const mongoose = require("mongoose");

exports.fetchPurchaseReturnWithTaxReport = async (req, res) => {
    try {
        ...
        let PurchaseReturnData = await PurchaseReturns.aggregate([
        ...
        let DbnWithNoItems = await PurchaseReturns.aggregate([
            {
                $match: {
                    ...searchConditions,
                    items: { $size: 0 },
        ...
        PurchaseReturnData = PurchaseReturnData.concat(DbnWithNoItems).sort(
        ...
        return res
            .status(200)
            .json({
                message: "Purchase-Return with Tax Report Fetched Successfully",
